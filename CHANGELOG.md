...
## [1.0.0](https://github.com/Mu-L/asdf/compare/v0.15.0...v1.0.0) (2024-12-24)


### ⚠ BREAKING CHANGES

* Enable `pipefail` ([#1608](https://github.com/Mu-L/asdf/issues/1608))
* `plugin list` exit code 0 when no plugins are installed ([#1597](https://github.com/Mu-L/asdf/issues/1597))
* 0 exit code for success when adding an existing plugin ([#1598](https://github.com/Mu-L/asdf/issues/1598))
* **fish:** don't resolve symlinks for ASDF_DIR ([#1583](https://github.com/Mu-L/asdf/issues/1583))
* Remove files containing only `asdf` wrapper functions ([#1525](https://github.com/Mu-L/asdf/issues/1525))
* align Fish entrypoint behaviour with other shells ([#1524](https://github.com/Mu-L/asdf/issues/1524))
* do not remove items from PATH in POSIX entrypoint ([#1521](https://github.com/Mu-L/asdf/issues/1521))
* rework POSIX entrypoint for greater shell support ([#1480](https://github.com/Mu-L/asdf/issues/1480))

### Features

* add Golang tests to GitHub test workflow ([3a9f539](https://github.com/Mu-L/asdf/commit/3a9f539aa092fa7c043661232f8caa154e861c6f))
* add linting for Golang to GitHub lint workflow ([f41ce90](https://github.com/Mu-L/asdf/commit/f41ce90dc4410da7bb76c5ccf73147759716be07))
* add plugin location when update the plugin ([#1602](https://github.com/Mu-L/asdf/issues/1602)) ([36c7024](https://github.com/Mu-L/asdf/commit/36c7024baa4b829b3629b4e0430157266d354158))
* add post update plugin support ([#1049](https://github.com/Mu-L/asdf/issues/1049)) ([304f72d](https://github.com/Mu-L/asdf/commit/304f72dbb207606fd82c04ee2c73cf11e9e6e0cc))
* asdf latest defer to plugin to determine the latest version ([#938](https://github.com/Mu-L/asdf/issues/938)) ([664d82e](https://github.com/Mu-L/asdf/commit/664d82ed8a734eb30988840829a972f8ddd8e523))
* case-insensitive filtering of unstable versions in `latest` ([#1139](https://github.com/Mu-L/asdf/issues/1139)) ([e61e3d9](https://github.com/Mu-L/asdf/commit/e61e3d9ade0d7bdfb4413184284038c50ba1e09c))
* **completions:** bash improvements ([#1329](https://github.com/Mu-L/asdf/issues/1329)) ([7c802c3](https://github.com/Mu-L/asdf/commit/7c802c3fc9b5dc556993a98e5aaf96650cbb0d5b))
* correct description for version preceded by star ([04fe7e3](https://github.com/Mu-L/asdf/commit/04fe7e30ca88d6952260ef4aa9a91eea9c8ca104))
* Disable short-name repository with config value ([#1227](https://github.com/Mu-L/asdf/issues/1227)) ([18caea3](https://github.com/Mu-L/asdf/commit/18caea3eb7d989d195cf13b3c9ffc2058d906fc5))
* display plugin repo refs alongside urls in info cmd ([#1014](https://github.com/Mu-L/asdf/issues/1014)) ([cd0a6a7](https://github.com/Mu-L/asdf/commit/cd0a6a779eb18236fe7bf1f84403e33e636ef1f3))
* Displays a warning when a plugin from the tools-version list does not exist ([#1033](https://github.com/Mu-L/asdf/issues/1033)) ([9430a39](https://github.com/Mu-L/asdf/commit/9430a39aef1dbf806a8954d71711747be1001076))
* Elvish Shell support ([#1066](https://github.com/Mu-L/asdf/issues/1066)) ([cc7778a](https://github.com/Mu-L/asdf/commit/cc7778a040751f6801524135f5f5ece3a748fa8c))
* **golang-rewrite:** add boilerplate for cobra CLI commands ([d06d71f](https://github.com/Mu-L/asdf/commit/d06d71f9f6b2fd6069c6fbf27bc7b13b8b0ec5c2))
* **golang-rewrite:** add cobra library as dependency ([7d5281a](https://github.com/Mu-L/asdf/commit/7d5281a8a9151d57113ea0dd5d2fea2b07f55228))
* **golang-rewrite:** add config methods ([8ad3472](https://github.com/Mu-L/asdf/commit/8ad3472abc64d8a07589a16096142b52aeae18af))
* **golang-rewrite:** add placeholders for plugin subcommands ([b40beb6](https://github.com/Mu-L/asdf/commit/b40beb6039b031d350bd1c621f34d90f23f72765))
* **golang-rewrite:** BATS test fixes & `latest` command ([b23e5a3](https://github.com/Mu-L/asdf/commit/b23e5a320fd231c4fa55baa3b32d90b55a6ff4f1))
* **golang-rewrite:** build dev release binaries ([bc05110](https://github.com/Mu-L/asdf/commit/bc0511015920acd8421bbccaead86e2badf0c2ae))
* **golang-rewrite:** build golang asdf for BATS integration tests ([477e9d5](https://github.com/Mu-L/asdf/commit/477e9d57293b8c99bcb184cfc72e064f4b68eda0))
* **golang-rewrite:** compile asdf version into Go binaries ([6d708b2](https://github.com/Mu-L/asdf/commit/6d708b280720d2144ae7976229fd5630eeb31eaf))
* **golang-rewrite:** correct asdf-version workflow step to produce version as output ([572ed07](https://github.com/Mu-L/asdf/commit/572ed07f2bdb31f04a7244d1d127594ef9922db0))
* **golang-rewrite:** correct asdf-version workflow step to produce version as output ([19a0597](https://github.com/Mu-L/asdf/commit/19a0597502ebecb0dfe2946fe19d9f9da3d57a18))
* **golang-rewrite:** create `asdf current` command ([b33ab64](https://github.com/Mu-L/asdf/commit/b33ab6463c7825a0d03f82f430cfad18a1e941c8))
* **golang-rewrite:** create `asdf exec` command ([b966ca6](https://github.com/Mu-L/asdf/commit/b966ca66271f1be81abee751dec929f97cadfab4))
* **golang-rewrite:** create `asdf list` and `asdf list all` commands ([8db188a](https://github.com/Mu-L/asdf/commit/8db188a702b1a64812fbb6e5832ec74ed47dfb34))
* **golang-rewrite:** create `asdf uninstall` command ([3fd4a83](https://github.com/Mu-L/asdf/commit/3fd4a839757a2646054f2d86f487731e0715eeaa))
* **golang-rewrite:** create `asdf where` command ([09d06ff](https://github.com/Mu-L/asdf/commit/09d06ff125107c19a24043e52cf60b378b8b4c3b))
* **golang-rewrite:** create `asdf which` command ([d2afb85](https://github.com/Mu-L/asdf/commit/d2afb85eb80bce85e79c9c0d91ad3103a7f985f0))
* **golang-rewrite:** create `RunCallback` method for `Plugin` struct ([778ab34](https://github.com/Mu-L/asdf/commit/778ab34a6f47ac913a0ebc5035d74bfbb3744ebe))
* **golang-rewrite:** create `shims.FindExecutable` function for shim execution ([9f09f78](https://github.com/Mu-L/asdf/commit/9f09f78ec06b28bd90d7cdd42762acc1e18011c7))
* **golang-rewrite:** create `versions.InstallOneVersion` function ([6568891](https://github.com/Mu-L/asdf/commit/65688915a5d6816b15acf7332d22920d10e8d99a))
* **golang-rewrite:** create hooks ([771f184](https://github.com/Mu-L/asdf/commit/771f18493fcc8684f02373b2f03750937016f51a))
* **golang-rewrite:** create install command ([8313ebc](https://github.com/Mu-L/asdf/commit/8313ebca2d2305b8e176286ae0a43b0359d78059))
* **golang-rewrite:** create installs and installtest packages to avoid circular dependency ([be52d8f](https://github.com/Mu-L/asdf/commit/be52d8f39c3aa253496c5469963cd0ecc995d19c))
* **golang-rewrite:** create internal/resolve package ([c2e5ee6](https://github.com/Mu-L/asdf/commit/c2e5ee652532f54aaed7e93796f7239a2a333446))
* **golang-rewrite:** create Makefile ([9097696](https://github.com/Mu-L/asdf/commit/9097696a4fa5ad7efeb383509ecce16125df3cbf))
* **golang-rewrite:** create plugin list command ([ad0907a](https://github.com/Mu-L/asdf/commit/ad0907a74df1edf42e7c72ecba96ea52e3de2bcf))
* **golang-rewrite:** create plugin remove command ([2b02f51](https://github.com/Mu-L/asdf/commit/2b02f51fa1acb2090713f6dfa70903281d28735a))
* **golang-rewrite:** create plugin update command ([c480044](https://github.com/Mu-L/asdf/commit/c4800443bd805afd1878891c56108366f3faba0c))
* **golang-rewrite:** create pluginAddCommand function for plugin add command action ([26b91aa](https://github.com/Mu-L/asdf/commit/26b91aa8288787e552dbc50a1c2234ad2264205c))
* **golang-rewrite:** create pluginindex package ([202cdae](https://github.com/Mu-L/asdf/commit/202cdae831b4909280e0f19ff77bbe4acaec36b4))
* **golang-rewrite:** create plugins/git package to store plugin Git operations ([325cd33](https://github.com/Mu-L/asdf/commit/325cd3334b3898cbd084ac3b3686458cc92b613e))
* **golang-rewrite:** create settings and config structs for loading config ([07b5813](https://github.com/Mu-L/asdf/commit/07b5813566431ce9f6245e884fe86dd13ad1c195))
* **golang-rewrite:** create shimversions command ([822e14c](https://github.com/Mu-L/asdf/commit/822e14c561ab1df74f091bb46bcb340ae9c2bda6))
* **golang-rewrite:** create version 0.14 to 0.15 upgrade guide ([53cd454](https://github.com/Mu-L/asdf/commit/53cd4544741cab2e58ca7ea8aa36c9c28890b0a1))
* **golang-rewrite:** create versions.Latest function ([9f6a65f](https://github.com/Mu-L/asdf/commit/9f6a65f5dda41d25a9e894ff6a8482810fd6dec8))
* **golang-rewrite:** full version resolution ([bd7ab9a](https://github.com/Mu-L/asdf/commit/bd7ab9ae0844c4c9e41760661a555bab13509752))
* **golang-rewrite:** get all `install_command.bats` tests passing ([b6ec89f](https://github.com/Mu-L/asdf/commit/b6ec89f95f6afedbbdb2daaf4c3d2f67f50f0cf1))
* **golang-rewrite:** get remaining `shim_exec.bats` tests passing ([162cb8e](https://github.com/Mu-L/asdf/commit/162cb8eceed53f58c20c547d29ca8068e411ce64))
* **golang-rewrite:** implement `asdf help` command ([d94bace](https://github.com/Mu-L/asdf/commit/d94baceb184b8a501a8eb1fd2cd33ca75bf962d9))
* **golang-rewrite:** implement `asdf plugin list all` command ([e7df5ff](https://github.com/Mu-L/asdf/commit/e7df5ff3253b6caba8ceef6b0754d17fcb765a9b))
* **golang-rewrite:** implement `asdf plugin test` command ([369beeb](https://github.com/Mu-L/asdf/commit/369beebab9c80197eb877660add870c0a6be5bda))
* **golang-rewrite:** implement asdf env command ([26a3815](https://github.com/Mu-L/asdf/commit/26a38159483588cd0143b58272f42c96e127d265))
* **golang-rewrite:** implement asdf plugin extension commands ([ccc98ad](https://github.com/Mu-L/asdf/commit/ccc98ad4e997b73dcc1e9d6839a17a539c5ec649))
* **golang-rewrite:** info command ([447acd1](https://github.com/Mu-L/asdf/commit/447acd13d1225e2e9ef80ae853c5da02fca034c3))
* **golang-rewrite:** initialize golang module ([72c20b1](https://github.com/Mu-L/asdf/commit/72c20b1b51d223dd6633f279258cb8bc54eb4661))
* **golang-rewrite:** introduce `Version` struct, get some `shim_exec.bats` tests passing ([924eecf](https://github.com/Mu-L/asdf/commit/924eecfa6af25f59162e3f35b913a1d0247bd34f))
* **golang-rewrite:** make bats available for golang tests ([f5a5967](https://github.com/Mu-L/asdf/commit/f5a59677df42f990529bd8a1668fcfea353ea4a0))
* **golang-rewrite:** misc. plugin improvements ([3af0291](https://github.com/Mu-L/asdf/commit/3af02913169abf9049933abc4d99406687d743c3))
* **golang-rewrite:** misc. version improvements ([9ed4216](https://github.com/Mu-L/asdf/commit/9ed4216525a2076b84e9e5fc6d454746a3b4d825))
* **golang-rewrite:** misc. version improvements part 2 ([b9e79e6](https://github.com/Mu-L/asdf/commit/b9e79e64564ad5a94c9d435458e1a57053744b8d))
* **golang-rewrite:** more `asdf plugin remove` tests ([626bde0](https://github.com/Mu-L/asdf/commit/626bde0a9785e400eaeb2fa72fb11fff6102b458))
* **golang-rewrite:** more shim exec fixes ([f639f8a](https://github.com/Mu-L/asdf/commit/f639f8a4d0a3fcc3cc175def3b3b2d1ebdac1ade))
* **golang-rewrite:** more work to get `install_command.bats` test passing ([c0963a3](https://github.com/Mu-L/asdf/commit/c0963a38a62e61586ef0dd34ea568d23345e3739))
* **golang-rewrite:** move all Git code to git package ([cb49b64](https://github.com/Mu-L/asdf/commit/cb49b64a5adb8944acff0c03e617df0a0f39453c))
* **golang-rewrite:** offline Go tests ([f74efbf](https://github.com/Mu-L/asdf/commit/f74efbf1bff5d7489f86f2f568eba2667d95645e))
* **golang-rewrite:** PluginAdd function ([15e1f06](https://github.com/Mu-L/asdf/commit/15e1f06f3751c9b72deea5cbad587140ba03c645))
* **golang-rewrite:** re-organize Go code ([620c0d8](https://github.com/Mu-L/asdf/commit/620c0d87e8bf1e1c99a5772c9103fa017e75f487))
* **golang-rewrite:** refactor completion code and move all packages except `cmd` into `internal` ([518a0fa](https://github.com/Mu-L/asdf/commit/518a0fa4422cff1625cb7b676f40c4bc0a42eed9))
* **golang-rewrite:** remove `asdf update` command to prepare for Go version ([#1806](https://github.com/Mu-L/asdf/issues/1806)) ([15571a2](https://github.com/Mu-L/asdf/commit/15571a2d28818644673bbaf0fcf7d1d9e342cda4))
* **golang-rewrite:** rename module and move `main` pacakge to `cmd/asdf` ([5d5d04f](https://github.com/Mu-L/asdf/commit/5d5d04fbb7a41c83ae5031182d7d671fae434cb5))
* **golang-rewrite:** run bats integration tests in golang ([2fc8006](https://github.com/Mu-L/asdf/commit/2fc80064902a3b467a82466add1db186a99f075a))
* **golang-rewrite:** self-contained completion code ([c859384](https://github.com/Mu-L/asdf/commit/c8593842eeb2a3eae74af7747afc62fa406a5b54))
* **golang-rewrite:** set variables for bats integration tests ([2951011](https://github.com/Mu-L/asdf/commit/2951011090a2a8ac3f42d54198a2447213171c38))
* **golang-rewrite:** setup Golang release GitHub workflow ([c5092c6](https://github.com/Mu-L/asdf/commit/c5092c6dbfce3614f3de2db08afaa6fcb8b7792e))
* **golang-rewrite:** setup goreleaser ([3f9744d](https://github.com/Mu-L/asdf/commit/3f9744df0fd8b23684ef2c705642232c5d2151af))
* **golang-rewrite:** shim generation 2 ([985c181](https://github.com/Mu-L/asdf/commit/985c181118b39bb555a2bd2a1cdbf111a25bd512))
* **golang-rewrite:** shim generation part 1 ([18e21c9](https://github.com/Mu-L/asdf/commit/18e21c90284be35fa01e957b49336ffac515e19b))
* **golang-rewrite:** update upgrade guide ([0058988](https://github.com/Mu-L/asdf/commit/005898800bded840fa7dd9b62a0c60a93c124c8c))
* **golang-rewrite:** use plugin index ([8394e85](https://github.com/Mu-L/asdf/commit/8394e858fee419ed38833fa953b122fe04754830))
* **golang-rewrite:** use version type when generating shims ([5266ba5](https://github.com/Mu-L/asdf/commit/5266ba581ddf5f96de2d20391e340bb4f7c123c4))
* **golang-rewrite:** version file parsing ([3155dc3](https://github.com/Mu-L/asdf/commit/3155dc374e9cbea6d2d792fef08914124320a292))
* improved completions for version in commands ([82be580](https://github.com/Mu-L/asdf/commit/82be58060232ab765a0ef178d17118f4b0e93cb8))
* **latest:** adds the flag --all to the latest command ([#1096](https://github.com/Mu-L/asdf/issues/1096)) ([f85fef5](https://github.com/Mu-L/asdf/commit/f85fef533f249df5a9f58307d288f2f069351e88))
* mark current resolved versions in `asdf list` output ([#762](https://github.com/Mu-L/asdf/issues/762)) ([5ea6795](https://github.com/Mu-L/asdf/commit/5ea67953be74cb5fde11240dc40a541c69afc65c))
* Support configurable `ASDF_CONCURRENCY` ([#1532](https://github.com/Mu-L/asdf/issues/1532)) ([684f4f0](https://github.com/Mu-L/asdf/commit/684f4f058f24cc418f77825a59a22bacd16a9bee))
* support nushell ([#1355](https://github.com/Mu-L/asdf/issues/1355)) ([274a638](https://github.com/Mu-L/asdf/commit/274a638e155c08cd0d6dbda1a0d4da02c3466c97))
* Support PowerShell Core ([#1522](https://github.com/Mu-L/asdf/issues/1522)) ([213aa22](https://github.com/Mu-L/asdf/commit/213aa22378cf0ecf5b1924f1bfc4fee43338255a))
* toggle off repo sync completely ([#1011](https://github.com/Mu-L/asdf/issues/1011)) ([a3ba5a7](https://github.com/Mu-L/asdf/commit/a3ba5a794c07efb4aa9cce9c15d41b4b61d5df01))
* upgrade elvish to 0.17.0 ([#1159](https://github.com/Mu-L/asdf/issues/1159)) ([824550e](https://github.com/Mu-L/asdf/commit/824550ed2009c7e8c4c84afd7a01197d451c47bf))


### Bug Fixes

* `asdf info` show BASH_VERSION & all asdf envs ([#1513](https://github.com/Mu-L/asdf/issues/1513)) ([a1b5eee](https://github.com/Mu-L/asdf/commit/a1b5eeec1caf605c0e4c80748703b9e227b57aeb))
* `plugin list` exit code 0 when no plugins are installed ([#1597](https://github.com/Mu-L/asdf/issues/1597)) ([a029c00](https://github.com/Mu-L/asdf/commit/a029c007503f2eec911a0c836e8622bb38c5e065))
* `plugin test` git-ref to use plugin repo default branch ([#1694](https://github.com/Mu-L/asdf/issues/1694)) ([6d8cf9d](https://github.com/Mu-L/asdf/commit/6d8cf9d44b3d985ac59f1eac827c5275392f90fd))
* `reshim` did not rewrite executable path ([#1311](https://github.com/Mu-L/asdf/issues/1311)) ([5af7625](https://github.com/Mu-L/asdf/commit/5af76257693d1f560b9c27c9cdcc6f5a5a33c4d5))
* 0 exit code for success when adding an existing plugin ([#1598](https://github.com/Mu-L/asdf/issues/1598)) ([4dd1904](https://github.com/Mu-L/asdf/commit/4dd190466a9855dac300ce691e66a7629ef37b82))
* add asdf to list of banned commands ([#1224](https://github.com/Mu-L/asdf/issues/1224)) ([39909e0](https://github.com/Mu-L/asdf/commit/39909e01af2bbf23fc821de5cec6c5c9661c59bb))
* add missing "does not add paths to PATH more than once" test for elvish ([#1275](https://github.com/Mu-L/asdf/issues/1275)) ([3c55167](https://github.com/Mu-L/asdf/commit/3c55167a6807b48cacaaed18df7bf0db2526ed59))
* Add test for nushell integration and fix some bugs ([#1415](https://github.com/Mu-L/asdf/issues/1415)) ([60d4494](https://github.com/Mu-L/asdf/commit/60d4494d5d21f9d7bdd0778ca962ddb44280aff7))
* Adds "grep -P" to the list of banned commands ([#1064](https://github.com/Mu-L/asdf/issues/1064)) ([8a515f4](https://github.com/Mu-L/asdf/commit/8a515f49d7443ee318badbd4d8f092ad0d8f04ca))
* align Fish entrypoint behaviour with other shells ([#1524](https://github.com/Mu-L/asdf/issues/1524)) ([8919f40](https://github.com/Mu-L/asdf/commit/8919f4009ea233c32298911b28ceb879e2dbc675))
* Allow `path:` versions to use `~` ([#1403](https://github.com/Mu-L/asdf/issues/1403)) ([670c96d](https://github.com/Mu-L/asdf/commit/670c96d1a6d6d2c19ff63ce2ed14f784c340e9b9))
* allow plugin callbacks to be in any language ([#995](https://github.com/Mu-L/asdf/issues/995)) ([2ad0f5e](https://github.com/Mu-L/asdf/commit/2ad0f5ea452bd8f843951c4a9cc56a020e172b07))
* always use ASDF_DEFAULT_TOOL_VERSIONS_FILENAME for filename when present ([#1238](https://github.com/Mu-L/asdf/issues/1238)) ([711ad99](https://github.com/Mu-L/asdf/commit/711ad991043a1980fa264098f29e78f2ecafd610)), closes [#1082](https://github.com/Mu-L/asdf/issues/1082)
* append trailing newline to .tool-versions files when missing ([#1310](https://github.com/Mu-L/asdf/issues/1310)) ([eb7dac3](https://github.com/Mu-L/asdf/commit/eb7dac3a2b15ad458f55a897d49a377508ea92fe)), closes [#1299](https://github.com/Mu-L/asdf/issues/1299)
* assign default values to all internal variables ([#1518](https://github.com/Mu-L/asdf/issues/1518)) ([86477ee](https://github.com/Mu-L/asdf/commit/86477ee8dea14ab63faf7132133304855a647fde))
* avoid mention of `ASDF_NU_DIR` ([#1660](https://github.com/Mu-L/asdf/issues/1660)) ([dfea89c](https://github.com/Mu-L/asdf/commit/dfea89ccc703f3ef5a87c4b85726456d70167d89))
* Ban `ls` command ([#1141](https://github.com/Mu-L/asdf/issues/1141)) ([87137e4](https://github.com/Mu-L/asdf/commit/87137e41031f17b30acf12ee35925e689c84e2d8))
* ban grep long flags ([#1117](https://github.com/Mu-L/asdf/issues/1117)) ([6e4c39c](https://github.com/Mu-L/asdf/commit/6e4c39c244a289a54f235cf15a29874fb8885927))
* Ban use of 'test' ([#1383](https://github.com/Mu-L/asdf/issues/1383)) ([ec972cb](https://github.com/Mu-L/asdf/commit/ec972cbdf0acbecf70e3678c055e27866c49341d))
* bash completion for latest command ([#1472](https://github.com/Mu-L/asdf/issues/1472)) ([2606a87](https://github.com/Mu-L/asdf/commit/2606a875eba8d74be56c78c97a76f3eb92c8253d))
* Better handling with paths that include spaces ([#1485](https://github.com/Mu-L/asdf/issues/1485)) ([bbcbddc](https://github.com/Mu-L/asdf/commit/bbcbddcdd4ffa0f49c3772b66d87331420fa5727))
* clarify the wording when no version is set ([#1088](https://github.com/Mu-L/asdf/issues/1088)) ([4116284](https://github.com/Mu-L/asdf/commit/41162849cf5c966c749ec435ebe32bd649a86ee8))
* completions for asdf plugin list ([#1061](https://github.com/Mu-L/asdf/issues/1061)) ([43412aa](https://github.com/Mu-L/asdf/commit/43412aad5f668686daa058505a61c070561b46fc))
* **completions:** Address two Bash completion bugs ([#1770](https://github.com/Mu-L/asdf/issues/1770)) ([ebdb229](https://github.com/Mu-L/asdf/commit/ebdb229ce68979a18dae5c0922620b860c56b22f))
* correct order of checks in conditional for adding a missing newline ([#1418](https://github.com/Mu-L/asdf/issues/1418)) ([4125d2b](https://github.com/Mu-L/asdf/commit/4125d2b5560efc646e6048202ceb00fffd0b9eaf)), closes [#1417](https://github.com/Mu-L/asdf/issues/1417)
* Correct typo on getting started page ([#1086](https://github.com/Mu-L/asdf/issues/1086)) ([4321980](https://github.com/Mu-L/asdf/commit/4321980c3385ac1bafd77503c8ec77b26042d05b))
* create install directory with `mkdir -p` ([#1563](https://github.com/Mu-L/asdf/issues/1563)) ([d6185a2](https://github.com/Mu-L/asdf/commit/d6185a21207e0ac45e69499883dad5e2b585c1b6))
* do not print `find` errors ([#1102](https://github.com/Mu-L/asdf/issues/1102)) ([5992abb](https://github.com/Mu-L/asdf/commit/5992abb09e6f5e0af690bf0e99619386187949db))
* do not remove items from PATH in POSIX entrypoint ([#1521](https://github.com/Mu-L/asdf/issues/1521)) ([b6d0ca2](https://github.com/Mu-L/asdf/commit/b6d0ca28d5fd2b63c7da67b127e6c2a0e01b2670))
* Do not use `pwd` ([dd37b6f](https://github.com/Mu-L/asdf/commit/dd37b6f0c0ed20d15e3d96b730db82f21c9e2e6f))
* Do not use type not exported on older Python versions ([#1409](https://github.com/Mu-L/asdf/issues/1409)) ([7460809](https://github.com/Mu-L/asdf/commit/74608098cdfc70c2d2e85d1f3861500ef668a041))
* don't generate on error if backup file doesn't exists ([#1057](https://github.com/Mu-L/asdf/issues/1057)) ([288468f](https://github.com/Mu-L/asdf/commit/288468f93f6c5cb4e7cca1173d4ad73154d0d564))
* don't invoke asdf inside asdf commands ([#1208](https://github.com/Mu-L/asdf/issues/1208)) ([27f7ef7](https://github.com/Mu-L/asdf/commit/27f7ef78529649534b8383daa58e4b370b3cbd7f))
* don't override existing ASDF_DIR ([#1008](https://github.com/Mu-L/asdf/issues/1008)) ([73efc9f](https://github.com/Mu-L/asdf/commit/73efc9fa97744c49c5004ee8bb9b6064b6ce22f2))
* **elvish:** prepend asdf paths to `$PATH` ([#1174](https://github.com/Mu-L/asdf/issues/1174)) ([682b7a1](https://github.com/Mu-L/asdf/commit/682b7a1d6dc1a35f7f8b0ddbab977e0a3dae2c9c))
* Enable `pipefail` ([#1608](https://github.com/Mu-L/asdf/issues/1608)) ([4085e55](https://github.com/Mu-L/asdf/commit/4085e5542bac824ea124610ad247c2f90d1b8d93))
* enforce & use consistent function definitions ([#1464](https://github.com/Mu-L/asdf/issues/1464)) ([e0fd7a7](https://github.com/Mu-L/asdf/commit/e0fd7a7be8bbbbf0f3cb6dc38cea3b62963eb0c9))
* enforce consistent shell redirection format ([#1533](https://github.com/Mu-L/asdf/issues/1533)) ([1bc205e](https://github.com/Mu-L/asdf/commit/1bc205e8aa61287c766c673acb8f0d4f9c6ee249))
* ensure shims get created when data dir has spaces ([#996](https://github.com/Mu-L/asdf/issues/996)) ([39c9999](https://github.com/Mu-L/asdf/commit/39c9999519a1d3c51ffb3b8dddd141dbc29b3bd1))
* excludes "milestone" releases in "latest" command ([#1307](https://github.com/Mu-L/asdf/issues/1307)) ([5334d1d](https://github.com/Mu-L/asdf/commit/5334d1db3d390c46ed49101528f74483eb6b2987)), closes [#1306](https://github.com/Mu-L/asdf/issues/1306)
* **fish:** don't resolve symlinks for ASDF_DIR ([#1583](https://github.com/Mu-L/asdf/issues/1583)) ([d1a563d](https://github.com/Mu-L/asdf/commit/d1a563dcc0107d5c631f73b114044898b5cadcf9))
* **fish:** use builtin realpath over system one ([#1637](https://github.com/Mu-L/asdf/issues/1637)) ([5ac3032](https://github.com/Mu-L/asdf/commit/5ac30328a7bbd1a8d974bb5fb1f14d8bd2d1e03f))
* **fish:** use PATH instead of fish_user_paths ([#1709](https://github.com/Mu-L/asdf/issues/1709)) ([5327697](https://github.com/Mu-L/asdf/commit/53276973f7c99695cd9a28b04c010b006d7f60ca))
* Fix plugin-test arg parsing ([#1084](https://github.com/Mu-L/asdf/issues/1084)) ([c911f2d](https://github.com/Mu-L/asdf/commit/c911f2d43198945f21bb25100c9dab5a375c780b))
* fixing bats ([#1215](https://github.com/Mu-L/asdf/issues/1215)) ([a9caa5b](https://github.com/Mu-L/asdf/commit/a9caa5bdffca5401798fb37e6f34af933b6ce0d2))
* force lwrcase plugin name fix capitalization mismatch errs ([#1400](https://github.com/Mu-L/asdf/issues/1400)) ([196a05b](https://github.com/Mu-L/asdf/commit/196a05b2dcef48f3a281350734c76ba7bc73fa81))
* full_version_name is not available here ([#1031](https://github.com/Mu-L/asdf/issues/1031)) ([8490526](https://github.com/Mu-L/asdf/commit/84905265467c9fdf618c11f69a5ae71408e18bea))
* get invalid ASDF_DATA_DIR when exec asdf shims by non-shell ([#1154](https://github.com/Mu-L/asdf/issues/1154)) ([b9962f7](https://github.com/Mu-L/asdf/commit/b9962f71564ce77cf97772cc100b80f9d77019b1))
* **golang-rewrite:** `asdf exec` and `asdf env` command fixes ([7dfa8b4](https://github.com/Mu-L/asdf/commit/7dfa8b40ae5e557b90fb7917bc86a569cf2bd0a6))
* **golang-rewrite:** add missing goreleaser argument ([5a24864](https://github.com/Mu-L/asdf/commit/5a2486463238e2473aab739520793011267be19f))
* **golang-rewrite:** allow directories returned by list-bin-paths to be absent from the file system ([80ac9bb](https://github.com/Mu-L/asdf/commit/80ac9bb51c684c04829328c28a06aa1f1f67a8f2))
* **golang-rewrite:** attempt to fix goreleaser GitHub workflow ([1b3c426](https://github.com/Mu-L/asdf/commit/1b3c42699a30b6bcc7295d3f433dad9cd520f130))
* **golang-rewrite:** comment out all BATS tests ([163d6b4](https://github.com/Mu-L/asdf/commit/163d6b4b462954a2f52b6a1b9e09faa806292260))
* **golang-rewrite:** correct go build command in lint workflow ([87d3c06](https://github.com/Mu-L/asdf/commit/87d3c06cf5dc859dab4d1af3dec290ed49651b67))
* **golang-rewrite:** fix dependencies script on linux ([3f17a80](https://github.com/Mu-L/asdf/commit/3f17a80fbe34ee68a3d5580798374caf1a7bc4ae))
* **golang-rewrite:** set dependencies between release-build jobs ([6b45a5e](https://github.com/Mu-L/asdf/commit/6b45a5e5f74f60a22fd20b331163f5e5d6a3881c))
* **golang-rewrite:** try to fix goreleaser ([2a31caf](https://github.com/Mu-L/asdf/commit/2a31cafd38128be86696c0a46e0223a95b8129fe))
* **golang-rewrite:** try to get goreleaser action to generate snapshot builds ([7439ea9](https://github.com/Mu-L/asdf/commit/7439ea916829f7c3f1f2932fa17b3d2848c2dbe7))
* **golang-rewrite:** update detect-changes logic for Golang tests ([88af4ee](https://github.com/Mu-L/asdf/commit/88af4eea00c395407a4b904e80e307ad864a6535))
* help for extension commands for plugins with hyphens in the name. ([#1048](https://github.com/Mu-L/asdf/issues/1048)) ([3e0cb9a](https://github.com/Mu-L/asdf/commit/3e0cb9aaea7f2bf282a18c4912454737fef0741b))
* help text as per new feats in [#633](https://github.com/Mu-L/asdf/issues/633) ([#991](https://github.com/Mu-L/asdf/issues/991)) ([0d95663](https://github.com/Mu-L/asdf/commit/0d956635b5cabe35f0895121929e8e668a3ee03d))
* improve formatting of ballad ([#1367](https://github.com/Mu-L/asdf/issues/1367)) ([e0c2c31](https://github.com/Mu-L/asdf/commit/e0c2c31fc3274387efdddebe1450f0662f91a726))
* improve lint and test scripts ([#1607](https://github.com/Mu-L/asdf/issues/1607)) ([b320803](https://github.com/Mu-L/asdf/commit/b3208031204aabad6e85346155baacab16862da8))
* improve readability of the non-set `nullglob` guard ([#1545](https://github.com/Mu-L/asdf/issues/1545)) ([f273612](https://github.com/Mu-L/asdf/commit/f273612155188f62cf8daf584d5581cd4214daf4))
* incorrect usage of grep ([#1035](https://github.com/Mu-L/asdf/issues/1035)) ([30d27cb](https://github.com/Mu-L/asdf/commit/30d27cbe6b358cd790fb66dbc8a14806eca23f05))
* instead /tmp, use TMPDIR if defined ([9113623](https://github.com/Mu-L/asdf/commit/91136234e90b5fe8718338f513fa770c99151d3e))
* Introduce `ASDF_FORCE_PREPEND` variable on POSIX entrypoint ([#1560](https://github.com/Mu-L/asdf/issues/1560)) ([5b7d0fe](https://github.com/Mu-L/asdf/commit/5b7d0fea0a10681d89dd7bf4010e0a39e6696841))
* latest --all correctly report plugins as missing ([#1118](https://github.com/Mu-L/asdf/issues/1118)) ([aafe1e5](https://github.com/Mu-L/asdf/commit/aafe1e5304c2d2a026831976c18faa6fb48d25bc))
* lint & style errors in `bin/asdf` ([#1516](https://github.com/Mu-L/asdf/issues/1516)) ([13c0e2f](https://github.com/Mu-L/asdf/commit/13c0e2fab0e9ad4dccf72b6f5586fb32458b8709))
* lint errors from `scripts/checkstyle.py` ([#1385](https://github.com/Mu-L/asdf/issues/1385)) ([3492043](https://github.com/Mu-L/asdf/commit/3492043241e466337c5965a6fe2e089147bc4152))
* list `asdf version` command under help.txt UTILS section ([#1673](https://github.com/Mu-L/asdf/issues/1673)) ([240a5fb](https://github.com/Mu-L/asdf/commit/240a5fbdea1de055672d02f83db1de990ea2bf83))
* local plugin in then clause too ([#1203](https://github.com/Mu-L/asdf/issues/1203)) ([448f750](https://github.com/Mu-L/asdf/commit/448f750891a4366f45d905b112ad20d4be66c496))
* Make asdf.fish compatible with Fish 3.1.2 ([#1590](https://github.com/Mu-L/asdf/issues/1590)) ([e83d71e](https://github.com/Mu-L/asdf/commit/e83d71e43f525453994eb4cfda8ad66f8b914529))
* make fish shell setup match other shells ([#1209](https://github.com/Mu-L/asdf/issues/1209)) ([6fc4bb8](https://github.com/Mu-L/asdf/commit/6fc4bb8fc650e73152ce326267f89df6865cdd24))
* make plugin-test work on alpine linux ([#1778](https://github.com/Mu-L/asdf/issues/1778)) ([f5a1f3a](https://github.com/Mu-L/asdf/commit/f5a1f3a0a8bb50796f6ccf618d2bf4cf3bdea097))
* mv dev dep from repo root to subdir to avoid clash ([#1408](https://github.com/Mu-L/asdf/issues/1408)) ([5df70da](https://github.com/Mu-L/asdf/commit/5df70dadacd66b4150ed47e58c861418c0d1281f))
* newline after error msg for ASDF_DIR ([#1113](https://github.com/Mu-L/asdf/issues/1113)) ([ac2791e](https://github.com/Mu-L/asdf/commit/ac2791e49f7fcdbeb420415d8ddcb5f17bcf296e))
* no longer write temporary files to home directory ([#1592](https://github.com/Mu-L/asdf/issues/1592)) ([624604a](https://github.com/Mu-L/asdf/commit/624604a8626dc6006d78121d4cf0f6c920449c56))
* nushell language syntax update ([#1624](https://github.com/Mu-L/asdf/issues/1624)) ([0ddab5d](https://github.com/Mu-L/asdf/commit/0ddab5dfaf28ad97c84a6aa56b08ccc212e07b4d))
* nushell PATH conversion to list before filter ([#1471](https://github.com/Mu-L/asdf/issues/1471)) ([cd0e12b](https://github.com/Mu-L/asdf/commit/cd0e12b3ee4090242b884ac4aea0f65784e52946))
* Nushell plugin list --urls ([#1507](https://github.com/Mu-L/asdf/issues/1507)) ([9363fb2](https://github.com/Mu-L/asdf/commit/9363fb2f72e7fa08d3580b22d465af48a7d37031))
* nushell plugin list all ([#1501](https://github.com/Mu-L/asdf/issues/1501)) ([#1502](https://github.com/Mu-L/asdf/issues/1502)) ([c5b8b3c](https://github.com/Mu-L/asdf/commit/c5b8b3c128b48e1531f6d03d2083435f413a4738))
* nushell spread operator ([#1777](https://github.com/Mu-L/asdf/issues/1777)) ([a0ce37b](https://github.com/Mu-L/asdf/commit/a0ce37b89bd5eb4ddaa806f96305ee99a8c5d365))
* **nushell:** Use `def --env` instead of `def-env` ([#1681](https://github.com/Mu-L/asdf/issues/1681)) ([3b8f400](https://github.com/Mu-L/asdf/commit/3b8f400c3e628851286bfebd8da5bc7ab45cd676))
* **nushell:** Use correct env var for shims dir ([#1742](https://github.com/Mu-L/asdf/issues/1742)) ([2f07629](https://github.com/Mu-L/asdf/commit/2f0762991c35da933b81ba6ab75457a504deedbb))
* Only display the "can't keep downloads" warning when asked to keep downloads ([#1756](https://github.com/Mu-L/asdf/issues/1756)) ([44f3efb](https://github.com/Mu-L/asdf/commit/44f3efb63b7517520f4610d504d30783a85c9d79))
* only iterate over directories in the plugins/ directory ([#1228](https://github.com/Mu-L/asdf/issues/1228)) ([788ccab](https://github.com/Mu-L/asdf/commit/788ccab5971cb828cf25364b0df5ed6f5e9e713d))
* plugin extension commands to not require `bin/` directory ([#1643](https://github.com/Mu-L/asdf/issues/1643)) ([61420ad](https://github.com/Mu-L/asdf/commit/61420ad90829b2c9bf1ca16681a2eb652adcc755))
* Prepend asdf directories to the PATH in Nushell ([#1496](https://github.com/Mu-L/asdf/issues/1496)) ([745950c](https://github.com/Mu-L/asdf/commit/745950c3589c4047a5b94b34bc9cf06dff5dc3c7))
* Prevent unbound variable error with nounset in asdf.sh ([#1158](https://github.com/Mu-L/asdf/issues/1158)) ([b7dd291](https://github.com/Mu-L/asdf/commit/b7dd291c983af321af20550fa89bf1cfbc888aec))
* Quote commands correctly in plugin-test ([#1078](https://github.com/Mu-L/asdf/issues/1078)) ([69ff2d0](https://github.com/Mu-L/asdf/commit/69ff2d0c9a4fd273c9dac151345f60f7b146e569))
* regex validate plugin names on plugin add cmd ([#1010](https://github.com/Mu-L/asdf/issues/1010)) ([7697e6e](https://github.com/Mu-L/asdf/commit/7697e6e344809ab4603d0764fb8a969c2bbaf3b6))
* Remove `==` inside `[` ([#1421](https://github.com/Mu-L/asdf/issues/1421)) ([d81b81f](https://github.com/Mu-L/asdf/commit/d81b81f9de2dc5961624464df04cef7cafae588c))
* remove comments from whole file instead of line by line for performance ([#1198](https://github.com/Mu-L/asdf/issues/1198)) ([de6e22f](https://github.com/Mu-L/asdf/commit/de6e22f909946f7d17047f4aeab41e581546b674))
* Remove files containing only `asdf` wrapper functions ([#1525](https://github.com/Mu-L/asdf/issues/1525)) ([00fee78](https://github.com/Mu-L/asdf/commit/00fee78423de0e399f5705bb483e599e39b707c9))
* remove leading asterick in Fish completion ([#1543](https://github.com/Mu-L/asdf/issues/1543)) ([198ced5](https://github.com/Mu-L/asdf/commit/198ced50327b20b136cb6ec165610d37334a2962))
* Remove unecessary backslashes ([#1384](https://github.com/Mu-L/asdf/issues/1384)) ([15faf93](https://github.com/Mu-L/asdf/commit/15faf93a0d3615834e550ea1562fb6b8cee5a205))
* Remove usage of `$(pwd)` in favor of `$PWD` ([f522ab9](https://github.com/Mu-L/asdf/commit/f522ab98797345d767b239041246dfb4b740423e))
* rename internal function `asdf_tool_versions_filename` ([#1544](https://github.com/Mu-L/asdf/issues/1544)) ([b36ec73](https://github.com/Mu-L/asdf/commit/b36ec7338654abc3773314147540dfa8297b48b8))
* rename internal plugin repository functions ([#1537](https://github.com/Mu-L/asdf/issues/1537)) ([5367f1f](https://github.com/Mu-L/asdf/commit/5367f1f09079070c7b47551dc453c686991564a0))
* rework POSIX entrypoint for greater shell support ([#1480](https://github.com/Mu-L/asdf/issues/1480)) ([3379af8](https://github.com/Mu-L/asdf/commit/3379af845ed2e281703bc0e9e4f388a7845edc2a))
* Sed improvements ([#1087](https://github.com/Mu-L/asdf/issues/1087)) ([4b93bc8](https://github.com/Mu-L/asdf/commit/4b93bc81aa982b72621cd09e71eeea71ee009185))
* sed re error trailing backslash on FreeBSD ([#1046](https://github.com/Mu-L/asdf/issues/1046)). ([#1047](https://github.com/Mu-L/asdf/issues/1047)) ([47e8fb0](https://github.com/Mu-L/asdf/commit/47e8fb051b3577d251376976d5767c520f3524fc))
* set default shell version values on POSIX entrypoint ([#1594](https://github.com/Mu-L/asdf/issues/1594)) ([4d5f22d](https://github.com/Mu-L/asdf/commit/4d5f22ddb89ce53e24b1ab1cbefce3be95238a19))
* shorthand grep options for alpine support ([#1106](https://github.com/Mu-L/asdf/issues/1106)) ([234778a](https://github.com/Mu-L/asdf/commit/234778a397f19c398d2f76a0321fef3273c9a086))
* support `asdf shim-versions` completions in fish & bash ([#1554](https://github.com/Mu-L/asdf/issues/1554)) ([99623d7](https://github.com/Mu-L/asdf/commit/99623d7eac0fe17e330a950c71b7ba378f656b2c))
* support latest with filter on local and global ([#633](https://github.com/Mu-L/asdf/issues/633)) ([5cf8f89](https://github.com/Mu-L/asdf/commit/5cf8f8962fbd5fe2bc86856bc4676f88e1aa8885))
* support nushell v0.75.0 ([#1481](https://github.com/Mu-L/asdf/issues/1481)) ([dd8d399](https://github.com/Mu-L/asdf/commit/dd8d3999d41cfdd8518a9ea478929b5291b8838c))
* Typo in POSIX entrypoint ([#1562](https://github.com/Mu-L/asdf/issues/1562)) ([6b2ebf5](https://github.com/Mu-L/asdf/commit/6b2ebf575ff98d3970b518de04238d30804a40d1))
* update elvish to 0.18.0 ([5a89563](https://github.com/Mu-L/asdf/commit/5a89563c0a37f244fa3daa46c5100b7711edde1d))
* update event trigger for doc-version workflow ([#1232](https://github.com/Mu-L/asdf/issues/1232)) ([0bc8c3a](https://github.com/Mu-L/asdf/commit/0bc8c3ab6895b88c96bff86f5f79575ee80cc718))
* update GitHub workflows to work private asdf Go fork ([3e11bd4](https://github.com/Mu-L/asdf/commit/3e11bd4b330555a882c65d30e4c702888b185879))
* update plugin-add regex to support other languages ([#1241](https://github.com/Mu-L/asdf/issues/1241)) ([92d005d](https://github.com/Mu-L/asdf/commit/92d005dacd2ec434a9d912ab9938b59ab1b7c51f)), closes [#1237](https://github.com/Mu-L/asdf/issues/1237)
* updating references to legacy github.io site ([#1240](https://github.com/Mu-L/asdf/issues/1240)) ([738306b](https://github.com/Mu-L/asdf/commit/738306bc5d1c53a22c06e4d6d3ddb6d511dc5d50))
* use ELVISH_VERSION to specify elvish test version ([#1276](https://github.com/Mu-L/asdf/issues/1276)) ([72c3a23](https://github.com/Mu-L/asdf/commit/72c3a2377a1afa3027c6f29cb9f3f1a7fbddaa8c))
* Use more idiomatic fish ([#1042](https://github.com/Mu-L/asdf/issues/1042)) ([847ec73](https://github.com/Mu-L/asdf/commit/847ec73751ced9d149ce0826309fee0f894ca664))
* use universal scope for fish_user_paths ([#1699](https://github.com/Mu-L/asdf/issues/1699)) ([0ffee72](https://github.com/Mu-L/asdf/commit/0ffee7224bc00a917ceaea689c6268fd1f03bd62))
* wait until the plugin update are finished ([#1037](https://github.com/Mu-L/asdf/issues/1037)) ([7e1f2a0](https://github.com/Mu-L/asdf/commit/7e1f2a0d938052d4fa5ce6546f07b3decbd740cf))
* warn if `.tool-versions` or asdfrc contains carriage returns ([#1561](https://github.com/Mu-L/asdf/issues/1561)) ([097f773](https://github.com/Mu-L/asdf/commit/097f7733d67aaf8d0dca1c793407babbdf6f8394))
* warn if plugin does not support keeping downloads if configured ([#1644](https://github.com/Mu-L/asdf/issues/1644)) ([19515ed](https://github.com/Mu-L/asdf/commit/19515eda3b91167b0d76c35ffc4402de688007e0))
* warn when any ./lib/commands are marked as executable ([#1593](https://github.com/Mu-L/asdf/issues/1593)) ([2043a09](https://github.com/Mu-L/asdf/commit/2043a09574bdfdfcf2daf2fdb3bff2d9d2dad64e))
* when download path got removed, it should use -f to force delete the download files ([#1746](https://github.com/Mu-L/asdf/issues/1746)) ([221507f](https://github.com/Mu-L/asdf/commit/221507f1c0288f0df13315a7f0f2c0a7bc39e7c2))


### Performance Improvements

* only create dirs if they do not already exist ([#1566](https://github.com/Mu-L/asdf/issues/1566)) ([b6b8074](https://github.com/Mu-L/asdf/commit/b6b80749140aec6ae75e5568a5defd905196d5f2))
